...
name: [skill-name]
description: >
  [Third-person description of capabilities. Include WHEN to trigger (specific scenarios,
  keywords). Max 1024 chars. Minimum 20 words before the WHEN clause.]
  WHEN: [trigger phrase 1], [trigger phrase 2], [trigger phrase 3], [8+ phrases total].
license: "[your-license, e.g. Apache-2.0]"
metadata:
...
name: [skill-name]
description: >
  [Third-person description. Explicitly state when to trigger this skill - file types,
  operations, keywords.]
  WHEN: [trigger phrase 1], [trigger phrase 2], [8+ phrases total].
license: "[your-license, e.g. Apache-2.0]"
metadata:
  author: "[your-organization]"
  version: "1.0.0"
...
name: [skill-name]
description: >
  [Third-person description. Include domain keywords, document types, compliance
  standards that trigger this skill.]
  WHEN: [trigger phrase 1], [trigger phrase 2], [8+ phrases total].
license: "[your-license, e.g. Apache-2.0]"
metadata:
  author: "[your-organization]"
...
name: [skill-name]
description: >
  [Third-person description. Mention output types (documents, code), template types,
  when to use.]
  WHEN: [trigger phrase 1], [trigger phrase 2], [8+ phrases total].
license: "[your-license, e.g. Apache-2.0]"
metadata:
...
name: [skill-name]
description: >
  [Comprehensive description covering all capabilities - processing, validation,
  generation. Include all trigger keywords.]
  WHEN: [trigger phrase 1], [trigger phrase 2], [8+ phrases total].
license: "[your-license, e.g. Apache-2.0]"
metadata:
  author: "[your-organization]"
