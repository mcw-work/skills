...
description: >
  Builds and parses structured retrospective artifact folders for troubleshooting,
  incident review, and delivery retros. Use this skill when capturing session context,
  synthesizing external context (GitHub, Jira, Mattermost, logs), querying prior
  retrospectives, or preparing downstream inputs for postmortems and agent/skills/
  instruction improvements.
  WHEN: retrospective, retro, incident review, postmortem, session context, delivery retro,
  troubleshooting review, capture learnings, parse retrospective, query retrospective,
  okb entry, improvement artifacts.
license: Apache-2.0
metadata:
  author: Canonical/platform-engineering
  version: "1.0.0"
  summary: Build and parse structured retrospective folders for incidents, delivery reviews, and improvement artifacts.
  tags:
    - practices
    - retrospectives
    - delivery
